...
if (isset($_GET['id'])) {
    $maintenance = $maintenanceC->getMaintenance($_GET['id']);
}

if (isset($maintenance) && isset($_POST['name']) && isset($_POST['type']) && isset($_POST['description']) && isset($_POST['phone']) && isset($_POST['address'])) {
    $maintenance = new Model\Maintenance($maintenance['id'], $_POST['name'], $_POST['type'], $_POST['description'], $_POST['phone'], $_POST['address']);
    $maintenanceC->updateMaintenance($maintenance);
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="Name"
                                               ...
                                               type="text" name="name" value="<?= $maintenance['name'] ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type" id="Car parts">
                                            <option value="" <?php if ($maintenance['type'] == '') echo "selected" ?>>--
                                                Select Type --
                                            </option>
                                            <option value="Mechanic" <?php if ($maintenance['type'] == 'Mechanic') echo "selected" ?>>
                                                Mechanic
                                            </option>
                                            <option value="Electrician" <?php if ($maintenance['type'] == 'Electrician') echo "selected" ?>>
                                                Electrician
                                            </option>
                                            <option value="Taulier" <?php if ($maintenance['type'] == 'Taulier') echo "selected" ?>>
                                                Taulier
                                            </option>
                                            <option value="Diagnostic" <?php if ($maintenance['type'] == 'Diagnostic') echo "selected" ?>>
                                                Diagnostic
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="Phone"
                                               ...
                                               type="number" name="phone" value="<?= $maintenance['phone'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="Address">Address</label>
                                        <input class="form-control" id="Address" placeholder="Enter the Address"
                                               type="text" name="address" value="<?= $maintenance['address'] ?>">
                                    </div>
                                </div>
                                <!-- /.card-body -->
        ...
        $("#maintenance").validate({
            ...
            messages: {
                ...
                phone: {
                    ...
                    minlength: "Your phone number must consist of at least 8 numbers",
                    maxlength: "Your phone number must consist of at most 8 numbers",
