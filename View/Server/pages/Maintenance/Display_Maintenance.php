...
$maintenances = $maintenanceC->getMaintenances();

if (isset($_GET['id'])) {
    $maintenanceC->deleteMaintenance($_GET['id']);
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div>
                                    <a href="Add_Maintenance.php" class="btn btn-outline-success mx-4"><i
                                            class="fas fa-plus mx-2"></i>Add maintenance
                                    </a>
                                </div>
