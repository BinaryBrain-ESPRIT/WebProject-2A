...
if (isset($_POST['category']) && isset($_POST['brand']) && isset($_POST['model']) && isset($_POST['cylinder']) && isset($_POST['energy']) && isset($_POST['fiscalPower']) && isset($_POST['gearbox']) && isset($_POST['availability']) && isset($_POST['guarantee'])) {
    ...
    $car = new Model\NewCar(0, $category, $brand, $model, $cylinder, $energy, $fiscalPower, $gearbox, $availability, $guarantee, $fileNameNew);
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" id="newCarForm" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="carCategory">Category</label>
                                            <input class="form-control" placeholder="Enter the Category" type="text"
                                                name="category" id="carCategory">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Enter" type="text" name="model"
                                                id="carModel">
                                        </div>
                                        <div class="form-group">
                                            <label for="carCylinder">Cylinder</label>
                                            <br>
                                            <input class="form-control" placeholder="Enter Num of Cylinder"
                                                type="number" name="cylinder" id="carCylinder">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Enter the fiscal power"
                                                type="number" name="fiscalPower" id="carFiscalPow">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="imgURL" placeholder="Enter Image"
                                                type="file" name="file">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
