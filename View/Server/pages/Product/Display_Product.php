...
$prodC = new Controller\Product();
$products = $prodC->getProducts();

if (isset($_GET['id'])) {
    $prodC->deleteProduct($_GET['id']);
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div>
                                    <a href="Add_Product.php" class="btn btn-outline-success mx-4"><i
                                                class="fas fa-plus mx-2"></i>Add Product
                                    </a>
                                </div>
                                    ...
                                    foreach ($products as $product) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-around">
                                                ...
                                                <a href="Display_Product.php?id=<?php echo $product['id']; ?>"
