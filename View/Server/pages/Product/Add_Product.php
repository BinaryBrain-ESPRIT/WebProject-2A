                            ...
                            <form>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputMarque1">Marque</label>
                                        <input class="form-control" id="exampleInputMarque1" placeholder="Enter Marque"
                                               type="text" name="brand">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputNom1">Nom</label>
                                        <input class="form-control" id="exampleInputNom1" placeholder="Entrer nom"
                                               type="text" name="name">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputQuantite1">Quantite</label>
                                        <input class="form-control" id="exampleInputQuantite1"
                                               placeholder="Enter Quantite"
                                               type="number" name="qte">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPrix1">Prix</label>
                                        <input class="form-control" id="exampleInputPrix1" placeholder="Enter Prix"
