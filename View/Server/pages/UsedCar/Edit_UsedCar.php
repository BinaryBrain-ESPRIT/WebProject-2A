...
use Controller\UsedCar as UsedCarController;
use Model\UsedCar as UsedCarModel;

$carC = new UsedCarController();


if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $usedCar = $carC->getCar($id);
}

if (isset($_POST['category']) && isset($_POST['brand']) && isset($_POST['model']) && isset($_POST['cylinder']) && isset($_POST['energy']) && isset($_POST['fiscalPower']) && isset($_POST['gearbox']) && isset($_POST['registerNumber']) && isset($_POST['year']) && isset($_POST['kilometers']) && isset($_POST['imgURL'])) {

    $car = new Model\UsedCar( $_GET['id'], $_POST['category'], $_POST['brand'], $_POST['model'], $_POST['cylinder'], $_POST['energy'], $_POST['fiscalPower'], $_POST['gearbox'], $_POST['registerNumber'], $_POST['year'], $_POST['kilometers'], $_POST['imgURL']);
    $carC->updateCar($car);
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               id="carCategory" value="<?= $usedCar['category'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="carBrand">Brand</label>
                                        <br>
                                        <select class="form-control" name="brand" id="carBrand">
                                            <option value="" <?php if ($usedCar['brand'] == "") echo "selected" ?>>--
                                                Select Brand --
                                            </option>
                                            <option value="BMW" <?php if ($usedCar['brand'] == "BMW") echo "selected" ?>>
                                                BMW
                                            </option>
                                            <option value="Mercedes-Benz" <?php if ($usedCar['brand'] == "Mercedes-Benz") echo "selected" ?>>
                                                Mercedes-Benz
                                            </option>
                                            <option value="Land Rover" <?php if ($usedCar['brand'] == "Land Rover") echo "selected" ?>>
                                                Land Rover
                                            </option>
                                            <option value="Volkswagen" <?php if ($usedCar['brand'] == "Volkswagen") echo "selected" ?>>
                                                Volkswagen
                                            </option>
                                            <option value="Toyota" <?php if ($usedCar['brand'] == "Toyota") echo "selected" ?>>
                                                Toyota
                                            </option>
                                            <option value="KIA" <?php if ($usedCar['brand'] == "KIA") echo "selected" ?>>
                                                KIA
                                            </option>
                                            <option value="Hyundai" <?php if ($usedCar['brand'] == "Hyundai") echo "selected" ?>>
                                                Hyundai
                                            </option>
                                            <option value="Audi" <?php if ($usedCar['brand'] == "Audi") echo "selected" ?>>
                                                Audi
                                            </option>
                                            <option value="Peugeot" <?php if ($usedCar['brand'] == "Peugeot") echo "selected" ?>>
                                                Peugeot
                                            </option>
                                            <option value="Renault" <?php if ($usedCar['brand'] == "Renault") echo "selected" ?>>
                                                Renault
                                            </option>
                                            <option value="Seat" <?php if ($usedCar['brand'] == "Seat") echo "selected" ?>>
                                                Seat
                                            </option>
                                            <option value="Citroën" <?php if ($usedCar['brand'] == "Citroën") echo "selected" ?>>
                                                Citroën
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="Enter Num of Cylinder" type="number"
                                               name="cylinder" id="carCylinder" value="<?= $usedCar['cylinder'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="carEnergy">Energy</label>
                                        <br>
                                        <select class="form-control" name="energy" id="carEnergy">
                                            <option value="" <?php if ($usedCar['brand'] == "energy") echo "selected" ?>>
                                                -- Energy --
                                            </option>
                                            <option value="Essence" <?php if ($usedCar['energy'] == "Essence") echo "selected" ?>>
                                                Essence
                                            </option>
                                            <option value="Diesel" <?php if ($usedCar['energy'] == "Diesel") echo "selected" ?>>
                                                Diesel
                                            </option>
                                            <option value="Hybride" <?php if ($usedCar['energy'] == "Hybride") echo "selected" ?>>
                                                Hybride
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"
                                               ...
                                               id="carFiscalPow" value="<?= $usedCar['fiscalPower'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="cargearbox">gearbox</label>
                                        <br>
                                        <select class="form-control" name="gearbox" id="cargearbox">
                                            <option value="" <?php if ($usedCar['gearbox'] == "Citroën") echo "selected" ?>>
                                                -- Gear Box --
                                            </option>
                                            <option value="Automatic" <?php if ($usedCar['gearbox'] == "Automatic") echo "selected" ?>>
                                                Automatic
                                            </option>
                                            <option value="Manual" <?php if ($usedCar['gearbox'] == "Manual") echo "selected" ?>>
                                                Manual
                                            </option>
                                        </select>
                                    </div>
