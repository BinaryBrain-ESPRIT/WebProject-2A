                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                <h3 class="card-title">Used Cars List</h3>
                                <div class="">
                                    <a href="Add_UsedCar.php" class="btn btn-outline-success mx-4"><i
                                    ...
                                    foreach ($cars as $car) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-around">
                                                <a href="Edit_UsedCar.php?id=<?= $car['id'] ?>">
                                                    <button class="btn btn-outline-info">Edit</button>
                                                </a>
                                                <a href="Display_UsedCar.php?id=<?= $car['id'] ?>">
