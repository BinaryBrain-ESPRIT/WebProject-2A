                                ...
                                <table class="table table-bordered table-striped" id="example1">
                                    ...
                                    foreach ($commands as $command) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $command['total']?></td>
                                            <td> <a href="Command_Details.php?idCommand=<?=$command['id'] ?>">Command Products</a></td>
                                            <td><?= $command['date']?></td>
                                            <td class="d-flex justify-content-around">
                                                <a href="Display_Command.php?id=<?= $command['id']?>"
