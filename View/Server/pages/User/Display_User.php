                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div class="">
                                    <a href="Add_User.php" class="btn btn-outline-success mx-4"><i
                                                class="fas fa-plus mx-2"></i>
                                        Add User
                                    </a>
                                </div>
                            </div>
                                    ...
                                    foreach ($users as $user) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="tg-list-item">
                                                <a href="Display_User.php?ban=<?= $user['id'] ?>">
                                                    <?php if ($user['isBanned']) {
                                                        ?>
                                                        <a href="Display_User.php?unban=<?= $user['id'] ?>">
                                            ...
                                            <td class="tg-list-item">
                                                <a href="Display_User.php?admin=<?=$user['id']?>">
                                                    <?php if ($user['isAdmin'])
                                                    {
                                                        ?>
                                                        <a href="Display_User.php?unadmin=<?=$user['id']?>" >
                                                            <button class="btn btn-secondary">unAdmin</button>
                                                        </a>
                                                        <?php
                                                    } else {?>
                                                        <a href="Display_User.php?admin=<?=$user['id']?>">
                                            ...
                                            <td class="d-flex justify-content-around">
                                                ...
                                                <a class="btn btn-danger btn-sm"
                                                   href="Display_User.php?id=<?= $user['id'] ?>">
